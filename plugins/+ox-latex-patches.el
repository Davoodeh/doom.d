;;; plugins/+ox-latex-patches.el -*- lexical-binding: t; eval: (format-all-mode 0); -*-

;; https://github.com/kaushalmodi/.emacs.d/blob/master/elisp/patches/ox-latex-patches.el
